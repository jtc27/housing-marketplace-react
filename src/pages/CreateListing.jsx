...
function CreateListing() {
  ...
  const onSubmit = async (e) => {
    ...
    setLoading(false)
    toast.success('New listing has been created')
    navigate(`/category/${formDataCopy.type}/${docRef.id}`) //redirects to newly created listing
  }
    ...
    <div className='profile'>
      ...
      <main>
        <form onSubmit={onSubmit}>
          ...
          <label className='formLabel'>Name of Property</label>
          <input
